...
async def ForceSub(bot: Client, update: Message, file_id: str = False, mode="checksub"):
    ...
    try:
        ...
        text="""**Click The  𝗝𝗢𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 Button And Click Request to join channel Then You Can Search Files🦋

താഴെയുള്ള 𝗝𝗢𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ക്ലിക്ക് ചെയ്ത് Request to join channel ക്ലിക്ക് ചെയ്യുക അതിനു ശേഷം നിങ്ങൾക്ക് ആവശ്യമുള്ള ഫയൽസ് സെർച്ച്‌ ചെയ്യാവുന്നതാണ്..🥰**"""
