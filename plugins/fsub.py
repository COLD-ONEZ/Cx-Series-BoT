...
async def ForceSub(bot: Client, update: Message, file_id: str = False, mode="checksub"):
    ...
    try:
        ...
        text="""**Click The  𝗝𝗢𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 Button And Click Request to join channel Then Click BACK BUTTON in Your Phone and select season again you will get the Files..🦋

താഴെയുള്ള 𝗝𝗢𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ക്ലിക്ക് ചെയ്ത് Request to join channel ക്ലിക്ക് ചെയ്യുക അതിനു ശേഷം നിങ്ങളുടെ ഫോണിൽ BACK BUTTON ക്ലിക്ക് ചെയ്ത് Season വീണ്ടും സെലക്റ്റ് ചെയ്‌താൽ നിങ്ങൾക്ക് ആവശ്യമുള്ള Files ലഭിക്കുന്നതാണ്..🥰**"""
